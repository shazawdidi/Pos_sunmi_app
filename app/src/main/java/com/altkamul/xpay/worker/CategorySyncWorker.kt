...
@HiltWorker
public class CategorySyncWorker @AssistedInject constructor(
    ...
    override suspend fun doWork(): Result {
        Timber.d("Getting the updated category using a worker :) ")
        ...
        val response = api.syncCategories(currentVersion = currentVersion)
        /** We had the response */
        ...
        when(response){
            is ServerResponse.Success -> {
                ...
                /** After this , we should update our last version of category */
                dao.updateCategoryVersion(currentVersion,lastVersion)
